...
//   getObj.text = children[0].innerText;
//   getObj.amount = children[1].innerText;
//   getObj.transactionDate = children[2].innerText;
//   getObj.transactionCat = children[2].innerText;
  
//   const deleteIndex = transactions.findIndex((obj) => {
//     return obj.text === getObj.text && `$${obj.amount}` === getObj.amount && obj.transactionDate === getObj.transactionDate && obj.transactionCat === getObj.transactionCat;
//   });
